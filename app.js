...
function renderAssistant() {
  ...
  return heading('ASSISTANT PERSONNEL', 'Assistant IA', 'Il peut consulter toutes les données du tableau de bord et préparer des créations, modifications ou suppressions. Toute action attend ta confirmation.', '') +
    ...
    '</div><div class="stack">' +
      card('Données accessibles', '<div class="card-body"><p class="section-note">✓ Tâches et courses<br><br>✓ Comptes, mouvements, objectifs et taux d’intérêt<br><br>✓ Calendrier<br><br>✓ Notes<br><br>✓ Portfolio<br><br>✓ Lieux et paramètres<br><br>✓ Répertoire cuisine : lecture seule<br><br>◌ Mails : disponibles dès qu’une boîte mail est réellement connectée.</p></div>') +
